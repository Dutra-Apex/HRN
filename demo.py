...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_root', type=str, default='./assets/examples/multiview_webcam',
                        help='directory of input images')
    parser.add_argument('--output_root', type=str, default='./assets/examples/tmultiview_webcam_results',
